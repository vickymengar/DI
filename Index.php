...
<head>
    ...
    <!-- Librerías Stylesheet -->
    <link href="./Recursos_index/lib/animate/animate.min.css" rel="stylesheet">
    <link href="./Recursos_index/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="./Recursos_index/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />

    <!-- Estilos de Bootstrap -->
    <link href="./Recursos_index/css/bootstrap.min.css" rel="stylesheet">

    <!-- Estilos css -->
    <link href="./Recursos_index/css/style.css" rel="stylesheet">
</head>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <h1 class="text-primary m-0"><img src="./Recursos_index/img/logo.png" alt="Logo">El Arca</h1>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Reservar una Mesa</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="./Recursos_index/img/hero.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="./Recursos_index/lib/wow/wow.min.js"></script>
    <script src="./Recursos_index/lib/easing/easing.min.js"></script>
    <script src="./Recursos_index/lib/waypoints/waypoints.min.js"></script>
    <script src="./Recursos_index/lib/counterup/counterup.min.js"></script>
    <script src="./Recursos_index/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="./Recursos_index/lib/tempusdominus/js/moment.min.js"></script>
    <script src="./Recursos_index/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="./Recursos_index/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>

    <!-- Template Javascript -->
    <script src="./Recursos_index/js/main.js"></script>
</body>
